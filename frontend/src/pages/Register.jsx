...
import { BarChart3, Eye, EyeOff, User, Mail, Lock, Ruler, Scale, Calendar, Target, Activity } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-6 sm:p-8 lg:p-12">
              ...
              <div className="lg:hidden text-center mb-8">
                ...
                <p className="text-gray-600 mt-2">Join thousands tracking their fitness journey</p>
              </div>
