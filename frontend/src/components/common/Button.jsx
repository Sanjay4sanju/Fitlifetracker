...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 active:bg-primary-800 shadow-lg shadow-primary-500/25',
  ...
  const sizes = {
    ...
    large: 'px-6 py-4 text-base min-h-[52px] font-semibold'
  };
