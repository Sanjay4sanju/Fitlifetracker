...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    if (origin.includes('localhost:') || 
        ...
        origin.includes('vercel.app') ||
        origin === 'https://fitlifetracke-r-b2cd.vercel.app' ||
        origin === 'https://fitlifetracke-r-b2cd-git-main-john-devs-projects-dc2575c3.vercel.app' ||
        origin === 'https://fitlifetracke-r-b2cd-onewioyrw-john-devs-projects-dc2575c3.vercel.app') {
